...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Stock'
        db.create_table('financeapp_stock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smirik_auth.User'], related_name='items')),
        ))
        db.send_create_signal('financeapp', ['Stock'])


    def backwards(self, orm):
        # Deleting model 'Stock'
        db.delete_table('financeapp_stock')
