...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('financeapp_stock', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Stock', fields ['name']
        db.create_unique('financeapp_stock', ['name'])
    ...
    models = {
        ...
        'financeapp.stock': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['smirik_auth.User']"})
        },
        'smirik_auth.user': {
